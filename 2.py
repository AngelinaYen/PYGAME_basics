...
#fonts = pygame.font.get_fonts() //取得所有PYTHON內建字型
system_font = pygame.font.SysFont("centry", 64)
custom_font = pygame.font.Font("AbstractGroovy.ttf", 50) #載入外部下載的字型

#Define Text:
show_text_1 = system_font.render("Angry Bird Game:", True, GREEN, DARKGREEN)
show_text_1_rect = show_text_1.get_rect() #產生自體的功能
...
#背景音樂
pygame.mixer.music.load("music.wav") #重複播放，從頭播放
